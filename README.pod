...
=head1 The GNews module

This is the I<README> for the L<GNews> Perl module.
...
To read about L<GNews>, look at the embedded documentation
in the module itself. Inside the distribution, you can format it
with L<perldoc|http://perldoc.perl.org/perldoc.html>:

	% perldoc lib/GNews.pm
...
L<MetaCPAN|http://www.metacpan.org/pod/GNews>.
...
the source repository: L<https://github.com/briandfoy/gnews>

If you find a problem, file a ticket in the L<issue
tracker|https://github.com/briandfoy/gnews/issues>.
...
=item * L<https://bitbucket.com/briandfoy/gnews>

=item * L<https://codeberg.org/briandfoy/gnews>

=item * L<https://gitlab.com/briandfoy/gnews>
...
You need a GitHub account and the L<gh tool|https://github.com/larsks/ghcli>.
	...
	$ gh auth login
	...follow instructions...
	$ gh attestation verify GNews-1.23.tar.gz --owner briandfoy
